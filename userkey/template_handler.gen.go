...
const TemplateName = "userkey"

// Instance is constructed by Mixer for the 'userkey' template.
...
// process data associated with the 'userkey' template.
//
...
type HandlerBuilder interface {
	...
	// SetUserkeyTypes is invoked by Mixer to pass the template-specific Type information for instances that an adapter
	// may receive at runtime. The type information describes the shape of the instance.
	SetUserkeyTypes(map[string]*Type /*Instance name -> Type*/)
}
...
// at configuration time via the method 'SetUserkeyTypes'.
// These Type associated with an instance describes the shape of the instance
type Handler interface {
	adapter.Handler

	// HandleUserkey is called by Mixer at request time to deliver instances to
	// to an adapter.
	HandleUserkey(context.Context, *Instance) (adapter.CheckResult, *Output, error)
}
