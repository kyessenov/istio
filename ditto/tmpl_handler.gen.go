...
const TemplateName = "ditto"

// Instance is constructed by Mixer for the 'ditto' template.
...
// process data associated with the 'ditto' template.
//
...
type HandlerBuilder interface {
	...
	// SetDittoTypes is invoked by Mixer to pass the template-specific Type information for instances that an adapter
	// may receive at runtime. The type information describes the shape of the instance.
	SetDittoTypes(map[string]*Type /*Instance name -> Type*/)
}
...
// at configuration time via the method 'SetDittoTypes'.
// These Type associated with an instance describes the shape of the instance
type Handler interface {
	adapter.Handler

	// HandleDitto is called by Mixer at request time to deliver instances to
	// to an adapter.
	HandleDitto(context.Context, *Instance) (adapter.CheckResult, error)
}
